            ...
            <form action="{{route('slider.update',[
                ...
                @method('put')
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" aria-describedby="title"  name="title" value="{{$slider->title}}">
                    @include('common.singleAlertError',['field'=>'title'])
                </div>
                <div class="form-group">
                    <label for="slider_image">Image</label>
                    <input type="file" class="form-control-file" id="slider_image" aria-describedby="slider_image" name="slider_image">
