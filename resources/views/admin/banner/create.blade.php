...
<div class="container">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="{{route('banner.index')}}" class="fw-normal">Banner Information</a></li>
                            </ol>
	...
	<div class="row">
        <div class="container">
            <h1 class="text-center">CREATE BANNER INFORMATION</h1>
        <form method="POST" action="{{ route('banner.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control" id="banner_image" aria-describedby="banner_image" name="banner_image">
