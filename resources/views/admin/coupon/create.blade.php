        ...
        <div class="row">
            <div class="container">
                ...
                <form action="{{ route('coupon.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="coupon_condition">Discount Type:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="coupon_price_discount"
                            aria-describedby="coupon_price_discount" name="coupon_price_discount"
                            value="{{ old('coupon_price_discount') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="coupon_use_number"
                            aria-describedby="coupon_use_number" name="coupon_use_number"
                            value="{{ old('coupon_use_number') }}">
